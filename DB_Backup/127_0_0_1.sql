...
--
-- Vært: 127.0.0.1
-- Genereringstid: 25. 11 2022 kl. 11:16:38
...
-- Database: `loftsort`
--
CREATE DATABASE IF NOT EXISTS `loftsort` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `loftsort`;

-- --------------------------------------------------------

--
-- Struktur-dump for tabellen `box`
--
...
--
-- Data dump for tabellen `box`
--

INSERT INTO `box` (`id`, `name`, `section`, `note`) VALUES
(1, 'Julepynt', 6, 'Her ligger der flot julepynt'),
(2, 'Legetøj', 16, 'Gammelt legetøj fra børnene'),
(7, 'Tøj', 15, 'Gammelt tøj');
...
INSERT INTO `item` (`id`, `name`, `section`, `note`) VALUES
(1, 'Gammelt fjernsyn', 1, ''),
(2, 'Build a bear', 14, 'Ligger i pose med andre bamser'),
(3, 'Beyblades', 13, ''),
(4, 'Gamle stuehøjtalere', 1, ''),
(5, 'Julekugler', 6, ''),
(6, 'Racerbane', 16, '');
...
--
-- Struktur-dump for tabellen `iteminbox`
--
...
--
-- Data dump for tabellen `iteminbox`
--

INSERT INTO `iteminbox` (`item_id`, `box_id`) VALUES
(5, 1);
...
(1, 'rasmusachr', 'Rasmus', '81dc9bdb52d04dc20036dbd8313ed055');
...
--
-- Indeks for tabel `box`
--
ALTER TABLE `box`
  ADD PRIMARY KEY (`id`);

--
-- Indeks for tabel `item`
--
ALTER TABLE `item`
  ADD PRIMARY KEY (`id`);

--
-- Indeks for tabel `iteminbox`
--
...
--
-- Tilføj AUTO_INCREMENT i tabel `box`
--
ALTER TABLE `box`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- Tilføj AUTO_INCREMENT i tabel `item`
--
ALTER TABLE `item`
...
--
-- Begrænsninger for tabel `iteminbox`
--
ALTER TABLE `iteminbox`
...
--
-- Data dump for tabellen `pma__designer_settings`
--
...
('root', '[{\"db\":\"loftsort\",\"table\":\"item\"},{\"db\":\"loftsort\",\"table\":\"iteminbox\"},{\"db\":\"loftsort\",\"table\":\"box\"}]');
...
('root', '2022-10-30 12:38:36', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"da\"}');
